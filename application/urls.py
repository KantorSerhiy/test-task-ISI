...
urlpatterns = [
    ...
    path(
        "threads/<int:pk>/delete/", ThreadDeleteAPIView.as_view(), name="thread-delete"
    ),
    ...
    path(
        "threads/message/create/", CreateMessageAPIView.as_view(), name="message-create"
    ),
    path(
        "threads/<int:thread_id>/messages/read/",
